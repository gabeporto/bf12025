...
export default function BettingsPage() {
  ...
  const gp = useMemo(() => {// Remove o primeiro elemento da URL
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <Card className="border-0 shadow-xl overflow-hidden">
            ...
            <CardContent className="p-6 bg-white">
              <BettingTable results={results} onScoresCalculated={handleScoresCalculated} isLoading={false} isSprint={true} />
            </CardContent>
          </Card>
        </div>
      </div>
