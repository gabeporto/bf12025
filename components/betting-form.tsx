...
const positionsSchema: Record<number, z.ZodTypeAny> = {}
for (let i = 0; i < 12; i++) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <Card>
          <CardHeader>
            <CardTitle>Informações do Apostador</CardTitle>
          </CardHeader>
          <CardContent>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Nome do Apostador</FormLabel>
                  <FormControl>
                    <Input placeholder="Digite seu nome" {...field} />
                  </FormControl>
                  <FormDescription>Este é o nome que aparecerá no ranking de apostas.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
